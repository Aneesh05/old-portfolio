...
const Hero = () => {
	...
	const firstLine = "Hi! My name is Aneesh Ereddy,".split(" ");
	const secondLine = "an aspiring Software Engineer.".split(" ");
	...
	return (
		<main className="flex flex-col items-center justify-center min-h-screen relative text-center">
			...
			>
				...
				>
					I&apos;m a Computer Engineering student studying at the university of Ottawa, currently
				...
				<div className="mt-8 flex justify-center items-center">
					<motion.a
						...
						variants={itemVariants}
						layout="position"
						href="/portfolio/assets/Aneesh_Ereddy_Resume.pdf"
						download
