	...
	const copyToClipboard = async () => {
		try {
			if (navigator.clipboard) {
				await navigator.clipboard.writeText("aneesh.ereddy@gmail.com");
			} else {
				const textArea = document.createElement("textarea");
				textArea.value = "aneesh.ereddy@gmail.com";
	...
	return (
		...
		>
			<div className="flex-grow flex flex-col justify-center items-center">
				...
				>
					<motion.a
						href="https://github.com/Aneesh05"
						target="_blank"
